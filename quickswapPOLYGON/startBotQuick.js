...
// BSC & Quickswap Libraries
const ethers = require('ethers');
const Web3 = require('web3');
const BN = Web3.utils.BN;
const abi = require('human-standard-token-abi');
const {Token, TokenAmount, Fetcher: v2Fetcher, Pair, Route, Trade, TradeType, Percent} = require('quickswap-sdk');
const {JsonRpcProvider} = require("@ethersproject/providers");

// To get the trade settings
const {tradeParameters} = require('./trading.paramsQuick.js');
const {globalParams} = require('./global.paramsQuick.js');
const {checkVariableValidity, checkInitialSettings, verboseTradeDescription} = require('./input-checksQuick.js');
    ...
    for (let thisTradePair in tradeParameters) {
        ...
        if (tradeParameters[thisTradePair].activate === true && thisTradePair !== 'template') {
            ...
            if (checkInitialSettings(tradeParameters[thisTradePair], midPrice)) {
                ...
                //  create log file
                var tickerStream = fs.createWriteStream(`TradeLogQuick.${dateStamp}.txt`, {flags: 'a'});
