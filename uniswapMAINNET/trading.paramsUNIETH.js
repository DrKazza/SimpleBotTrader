...
// LIMIT = '0x1712aad2c773ee04bdc9114b32163c058321cd85'
...
const tradeParameters = {
    pair1: {
        activate: true,
        buyAddress: '0x1712aad2c773ee04bdc9114b32163c058321cd85',
        ...
        buyPrice :  0.01, // set this to -1 if you don't want to buy any tokens
        sellPrice : 1500.8 // set this to -1 if you don't want to sell any tokens
    ...
    template: {
        ...
        buyAddress: 'ETH or an Address',
        sellAddress: 'ETH or an Address',
        buyMoonBag: 0, // Don't ever trade this number of buyAddress coins
        sellMoonBag: 0, // Don't ever trade this number of sellAddress coins
...
module.exports = {
    ...
    TRADE TYPE EXPLANATIONS:    
        ...
        TRADE TYPE 5:    TRAILING-STOP-LOSS
            ...
            to 200 for example you want to autoETHally move your Stop sell to 180 for example and to
    ...
    ****        amounts to trade         **************************************************************
     The bot will autoETHally try to trade all the token balance you have in your wallet...
     LESS the amount of tokens you specify in your respective moonbag...
     Also LESS the amount of _keepETH specified in the global parameters so you always have
